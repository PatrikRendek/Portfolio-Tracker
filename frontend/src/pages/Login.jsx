...
export default function Login() {
    ...
    return (
        <div className="min-h-[calc(100vh-4rem)] px-4 py-10 flex items-center justify-center bg-transparent">
            <div className="w-full max-w-6xl grid lg:grid-cols-[1.1fr_0.9fr] gap-6">
                <div className="hidden lg:flex rounded-3xl border border-gray-200 bg-white p-10 shadow-sm dark:border-[#202832] dark:bg-[#0a0e13] flex-col justify-between">
                    <div>
                        ...
                        <p className="text-[11px] uppercase tracking-[0.24em] text-gray-400 dark:text-slate-500 font-bold mb-3">Trading Desk Access</p>
                        <h1 className="text-4xl font-bold text-gray-900 dark:text-slate-50 leading-tight mb-4">Sign in to your portfolio workspace.</h1>
                        <p className="text-base text-gray-600 dark:text-slate-400 max-w-lg">
                            Monitor performance, benchmark your allocation and keep imports from eToro and XTB in one clean dashboard.
                        </p>
                    </div>
                    <div className="grid grid-cols-3 gap-4 text-sm">
                        <AuthStat label="Benchmarks" value="S&P 500" />
                        <AuthStat label="Imports" value="eToro / XTB" />
                        <AuthStat label="Mode" value="Desk UI" />
                    </div>
                </div>

                <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-[#202832] dark:bg-[#0a0e13]">
                    <div className="mb-8">
                        <div className="text-[11px] uppercase tracking-[0.24em] text-gray-400 dark:text-slate-500 font-bold mb-3">Sign In</div>
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-slate-50">Welcome back</h2>
                        <p className="text-sm text-gray-500 dark:text-slate-400 mt-2">Use your email or continue with Google.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <Field label="Email">
                            ...
                            <input
                                ...
                                className="w-full rounded-xl border border-gray-200 bg-white pl-10 pr-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 outline-none focus:border-blue-500 dark:border-[#202832] dark:bg-[#0f151d] dark:text-slate-100 dark:placeholder:text-slate-500"
                        ...
                        <Field label="Password">
                            ...
                            <input
                                ...
                                className="w-full rounded-xl border border-gray-200 bg-white pl-10 pr-10 py-3 text-sm text-gray-900 placeholder:text-gray-400 outline-none focus:border-blue-500 dark:border-[#202832] dark:bg-[#0f151d] dark:text-slate-100 dark:placeholder:text-slate-500"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3 rounded-xl bg-[#22324a] hover:bg-[#2a3d5a] text-white font-bold transition-colors disabled:opacity-50"
                        >
