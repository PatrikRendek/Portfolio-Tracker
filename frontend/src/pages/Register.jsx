        ...
        <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-8">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8 animate-fade-in-up">
                    ...
                    <p className="text-sm dark:text-gray-400 text-gray-600 mt-1">Join StockPulse and start tracking</p>
                </div>
                ...
                <div className="glass-card p-8 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                <label className="block text-sm font-medium dark:text-gray-300 text-gray-700 mb-1.5">First Name</label>
                                <div className="relative">
                                    <User size={18} className="absolute left-3 top-1/2 -translate-y-1/2 dark:text-gray-500 text-gray-400" />
                                    <input
                                        type="text"
                            ...
                            <div>
                                <label className="block text-sm font-medium dark:text-gray-300 text-gray-700 mb-1.5">Last Name</label>
                                <input
                                    type="text"
                                    value={form.lastName}
                        ...
                        <div>
                            <label className="block text-sm font-medium dark:text-gray-300 text-gray-700 mb-1.5">Confirm Password</label>
                            <div className="relative">
                                <Lock size={18} className="absolute left-3 top-1/2 -translate-y-1/2 dark:text-gray-500 text-gray-400" />
                                <input
                                    type="password"
